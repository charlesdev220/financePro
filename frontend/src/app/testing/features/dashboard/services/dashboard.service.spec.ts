...
describe('DashboardService', () => {
  ...
  describe('calculateSummary', () => {
    // REQ-01 sc1: rango con ingresos y gastos → totales y balance correctos
    it('calculateSummary_shouldReturnCorrectTotals_whenRangeHasIncomesAndExpenses', () => {
    ...
    // REQ-01 sc2: rango vacío → todos cero
    it('calculateSummary_shouldReturnAllZeros_whenRangeIsEmpty', () => {
      const transactions: ITransaction[] = [
  ...
  describe('calculateBreakdown', () => {
    ...
    // REQ-02 sc3: solo ingresos → devuelve solo ítems de tipo income
